...
// Validate checks the field values on TemplateOptions with the rules defined
...
// ValidateAll checks the field values on TemplateOptions with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// TemplateOptionsMultiError, or nil if none found.
func (m *TemplateOptions) ValidateAll() error {
	return m.validate(true)
}

func (m *TemplateOptions) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return TemplateOptionsMultiError(errors)
	}

	return nil
}

// TemplateOptionsMultiError is an error wrapping multiple validation errors
// returned by TemplateOptions.ValidateAll() if the designated constraints
// aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m TemplateOptionsMultiError) AllErrors() []error { return m }

// TemplateOptionsValidationError is the validation error returned by
// TemplateOptions.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e TemplateOptionsValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e TemplateOptionsValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e TemplateOptionsValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e TemplateOptionsValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e TemplateOptionsValidationError) ErrorName() string { return "TemplateOptionsValidationError" }
...
func (e TemplateOptionsValidationError) Error() string {
	...
	return fmt.Sprintf(
		"invalid %sTemplateOptions.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = TemplateOptionsValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = TemplateOptionsValidationError{}
