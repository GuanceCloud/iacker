...
const config: DocsThemeConfig = {
  logo: <span>Iacker</span>,
  project: {
    link: 'https://github.com/GuanceCloud/iacker'
  },
  chat: {
  ...
  docsRepositoryBase: 'https://github.com/GuanceCloud/iacker',
  sidebar: {
    autoCollapse: true,
    toggleButton: true,
  },
  ...
  banner: {
    ...
    text: (
      <a href="https://hacktoberfest.com/" target="_blank">
        🎉 Iacker is join to hacktoberfest. Read more →
      </a>
    )
  }
}
